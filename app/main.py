...
from app.routers import auth, alumno, examenes, intentos, capacitaciones, contenidos, historial, metricas, certificados, perfil
...
| `/auth` | Login, logout y rehidratación de sesión (/me) |
